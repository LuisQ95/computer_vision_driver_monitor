...
EAR_THRESHOLD = 0.22      # If EAR falls below this, eyes are considered closed
CONSECUTIVE_FRAMES = 15   # Frames to wait before sounding alarm for closed eyes
MAR_THRESHOLD = 0.60      # If MAR goes above this, a yawn is detected
AUDIO_FILE = "fahhhhh.wav" # IMPORTANT: winsound ONLY supports .wav files
        ...
        for face_landmarks in results.multi_face_landmarks:
            ...
            if avg_ear < EAR_THRESHOLD:
                ...
                if frame_counter >= CONSECUTIVE_FRAMES:
                    ...
                    # Reproducir sonido de forma asíncrona y sin interrumpir si ya está sonando
                    winsound.PlaySound(AUDIO_FILE, winsound.SND_FILENAME | winsound.SND_ASYNC | winsound.SND_NOSTOP)
            else:
